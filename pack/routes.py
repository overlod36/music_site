...
def file_saver(field, group_name):
...
def add_group():
	...
	if request.method == 'POST':
		...
		new_group = models.Group(name=form.name_field.data, main_cover_path=file_saver('cover_field', form.name_field.data), addin_cover_path=file_saver('add_cover_field', form.name_field.data), logo_path=file_saver('logo_field', form.name_field.data), current_members=get_list(form.current_members_field.data), past_members=get_list(form.past_members_field.data), active_years=form.active_years.data)
